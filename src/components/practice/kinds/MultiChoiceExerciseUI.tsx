          ...
          return (
            <button
              ...
              className={[
                ...
                on ? "border-emerald-400/40 bg-emerald-300/10" : "border-white/10 bg-white/[0.03] hover:bg-white/[0.06]",
              ...
              <div className="flex items-start gap-3">
                <div
                  className={[
                    ...
                    on ? "border-emerald-400/60 bg-emerald-400/40" : "border-white/20 bg-black/20",
                  ].join(" ")}
                />
